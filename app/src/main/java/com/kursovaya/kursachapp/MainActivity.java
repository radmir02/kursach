...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean saveWasClicked;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NotificationCompat.Builder builder =
                new NotificationCompat.Builder(MainActivity.this, CHANNEL_ID)
                        .setSmallIcon(R.drawable.mealbtn)
                        .setContentTitle("Напоминание")
                        .setContentText("Питомец скучает")
...
//        creatureList.add("tamarobotheadandspine");
        creatureList.add("pou");
        creatureList.add("pou");
       // creatureList.add("maria");
...
/*
            ...
            public void onClick(View v){
                ...
                submitButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String petInfo = nameEditText.getText().toString().toLowerCase().replace(" ", "_") + " 0 50 50 80 0 50 " + String.valueOf((int)(currentTimeMillis() / 1000)) + " " +
                ...
                if (loaded) {
                    ...
                    gameTwoButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            // Words for hangman
                            words = new ArrayList<>();
                            words.add("яблоко"); words.add("хлеб"); words.add("кошка"); words.add("собака"); words.add("слон"); words.add("лошадка");
                            words.add("воздух"); words.add("история"); words.add("лед"); words.add("прыжок"); words.add("сорость"); words.add("мальчик");
                            words.add("месяц");  words.add("осьминог"); words.add("картина"); words.add("звук"); words.add("гонка");
                            words.add("кнопка"); words.add("свет"); words.add("облако"); words.add("солнце"); words.add("дождь"); words.add("кошелек");
    ...
    private void updateGame(){
        myPet.ageUp((int)(currentTimeMillis() / 300));
        handlingDeath();
        save();
    }
    ...
    public void setSavebtn(View view){
        updateGame();
        Toast.makeText(this, "Прогресс сохранен", Toast.LENGTH_LONG).show();
    }
    private void save(){
        updateText();
        ...
        for (int i = 0; i < files.length; i++)
        {
            ...
            if(lengthOfSplit > 1 && files[i].getName().toString().split("\\.")[1].equals("pet") && !files[i].getName().toString().split("\\.")[0].equals("null")){
               ...
               // newButt.setBackgroundResource(R.drawable.petlistimage);
                ...
                deleteButt.setBackgroundResource(R.drawable.deletebtn);
                ...
                newButt.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            creatureImage.setBackgroundResource(resourceID);
                            creatureImage.setVisibility(View.VISIBLE);
                            if(myPet.getHappy() < 98){
                            Toast.makeText(getApplicationContext(),"С возращением! счастье (+2)",Toast.LENGTH_LONG).show();}
                            updateGame();
                            save();
                            loaded = true;
    ...
    private void changeSound(){
        if(soundORnot) {
            ...
            soundImageButton.setBackgroundResource(R.drawable.soundbtn);
            FileOutputStream outputStream;
            try{
                outputStream = openFileOutput("settings", Context.MODE_PRIVATE);
                outputStream.write("true".getBytes());
            ...
            soundImageButton.setBackgroundResource(R.drawable.mutesoundbtn);
            FileOutputStream outputStream;
            try{
                outputStream = openFileOutput("settings", Context.MODE_PRIVATE);
